...
public class ConfirmationPage extends javax.swing.JFrame {
     ...
     */
    public ConfirmationPage(Customer customer) {
    ...
    private void initComponents() {
        ...
        btnBack.setText("Back to Customer Home Page");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        CustomerHome cstHome = new CustomerHome(loggedInCustomer); // on assessment you have to pass logged in customer parameter back to home
        cstHome.setVisible(true);
        this.dispose();
